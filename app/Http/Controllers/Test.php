...
class Test
{
    public static function index()
    {
        ...
        // En effet au debut j'était parti sur l'idée de parcourir la chaine de caractère tout en ressortant les intervalles (d'où les deux dernières fonctions)
        // Mais je je me suis rendu compte que ca allait prendre plus de ressources que le spliter directement et y aller par occurences
